...
// custom markers so pickup / destination / driver / "you" are visually distinct
...
export const MapView = ({
    ...
    routeDestination: routeDestinationOverride,
    onRouteInfo,
}) => {
    ...
    const routeOrigin = routeOriginOverride !== undefined ? routeOriginOverride : pickup
    const routeDestination =
        routeDestinationOverride !== undefined
