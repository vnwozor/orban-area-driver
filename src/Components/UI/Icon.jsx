...
// Line icons (24x24, stroke). Add a new one by adding an entry below.
export const ICONS = {
  ...
  id: '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="11" r="2.5"/><path d="M14 9h4M14 13h4M6 17c.6-1.7 1.8-2.5 3-2.5s2.4.8 3 2.5"/>',
...
export const Logo = ({ size = 30 }) => (
    <svg viewBox='0 0 32 32' width={size} height={size} aria-hidden='true'>
        <circle cx='16' cy='16' r='10' fill='none' stroke='#FFB020' strokeWidth='5' />
        <circle cx='26' cy='26' r='3.6' fill='#F2F6FB' />
    </svg>
)
